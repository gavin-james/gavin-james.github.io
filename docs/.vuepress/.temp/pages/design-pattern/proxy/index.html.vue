<template><div><nav class="table-of-contents"><ul><li><router-link to="#代理模式的基本介绍">代理模式的基本介绍</router-link></li><li><router-link to="#静态代理">静态代理</router-link><ul><li><router-link to="#静态代理基本介绍">静态代理基本介绍</router-link></li><li><router-link to="#静态代理应用实例">静态代理应用实例</router-link></li><li><router-link to="#静态代理优缺点">静态代理优缺点</router-link></li></ul></li><li><router-link to="#动态代理">动态代理</router-link><ul><li><router-link to="#动态代理基本介绍">动态代理基本介绍</router-link></li><li><router-link to="#jdk-中生成代理对象的-api">JDK 中生成代理对象的 API</router-link></li><li><router-link to="#动态代理应用实例">动态代理应用实例</router-link></li></ul></li><li><router-link to="#cglib-代理">Cglib 代理</router-link><ul><li><router-link to="#cglib-代理基本介绍">Cglib 代理基本介绍</router-link></li><li><router-link to="#cglib-代理模式应用实例">Cglib 代理模式应用实例</router-link></li></ul></li><li><router-link to="#几种常见的代理模式介绍">几种常见的代理模式介绍</router-link></li><li><router-link to="#代理模式的应用场景">代理模式的应用场景</router-link></li></ul></nav>
<h2 id="代理模式的基本介绍" tabindex="-1"><a class="header-anchor" href="#代理模式的基本介绍" aria-hidden="true">#</a> 代理模式的基本介绍</h2>
...
<p><strong>代理模式</strong>（Proxy Pattern）：为一个对象提供一个替身，以控制对这个对象的访问。即通过代理对象访问目标对象。这样做的好处是：可以在目标对象实现的基础上，增强额外的功能操作，即扩展目标对象的功能。</p>
<p>被代理的对象可以是远程对象、创建开销大的对象或需要安全控制的对象。</p>
<p>代理模式有不同的形式，主要有三种 <strong>静态代理、动态代理</strong>（JDK 代理、接口代理）和 <strong>Cglib 代理</strong>（可以在内存动态的创建对象，而不需要实现接口，他是属于动态代理的范畴）。</p>
<blockquote>
<p>主要优点</p>
</blockquote>
<ul>
...
<p>代理模式示意图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213434.png" alt="image-20220314192143394" loading="lazy"></p>
<h2 id="静态代理" tabindex="-1"><a class="header-anchor" href="#静态代理" aria-hidden="true">#</a> 静态代理</h2>
<h3 id="静态代理基本介绍" tabindex="-1"><a class="header-anchor" href="#静态代理基本介绍" aria-hidden="true">#</a> 静态代理基本介绍</h3>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316221212.png" alt="image-20220316221211102" loading="lazy"></p>
<p>在代码中，一般代理会被理解为代码增强，实际上就是在原代码逻辑前后增加一些代码逻辑，而使调用者无感知。</p>
<h3 id="静态代理应用实例" tabindex="-1"><a class="header-anchor" href="#静态代理应用实例" aria-hidden="true">#</a> 静态代理应用实例</h3>
<ul>
...
<p>特别提醒：代理对象与目标对象要实现相同的接口，然后通过调用相同的方法来调用目标对象的方法。</p>
<p>思路分析图解（类图）</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213702.png" alt="image-20220316213701600" loading="lazy"></p>
<p>代码实现</p>
...
<h3 id="动态代理基本介绍" tabindex="-1"><a class="header-anchor" href="#动态代理基本介绍" aria-hidden="true">#</a> 动态代理基本介绍</h3>
<p>代理对象，不需要实现接口，但是目标对象要实现接口，否则不能用动态代理。</p>
<p>代理对象的生成，是利用 JDK 的 API，动态的在内存中构建代理对象。</p>
<p>动态代理也叫做：JDK 代理、接口代理。</p>
<h3 id="jdk-中生成代理对象的-api" tabindex="-1"><a class="header-anchor" href="#jdk-中生成代理对象的-api" aria-hidden="true">#</a> JDK 中生成代理对象的 API</h3>
<p>代理类所在包：<code v-pre>java.lang.reflect.Proxy</code>。</p>
<p>JDK 实现代理只需要使用 <code v-pre>newProxyInstance</code> 方法，但是该方法需要接收三个参数，完整的写法是：</p>
...
<ul>
<li>我们已经写了一个对象，这个对象已经成型（目标对象，旧对象）</li>
<li>时代变化，新功能出现，但是原来的目标对象成型，很难添加新的东西，于是我们需要重新造出一个对象</li>
<li>要求新的对象有旧的对象的所有功能，同时添加新的功能，于是需要 Proxy 动态代理（母亲）</li>
<li>怎么造出新对象呢，我们首先需要旧对象的基因（类加载器）和该对象的父类基因（类的父接口）</li>
<li>研究旧对象和其父亲的基因，造出新的对象，并且在造出的过程添加新的功能，于是新的对象更加全面</li>
</ul>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220325225315.png" alt="image-20220325225306403" loading="lazy"></p>
<h3 id="动态代理应用实例" tabindex="-1"><a class="header-anchor" href="#动态代理应用实例" aria-hidden="true">#</a> 动态代理应用实例</h3>
<p>将前面的静态代理改进成动态代理模式（即：JDK 代理模式）。</p>
<p>类图</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316215717.png" alt="image-20220316215716168" loading="lazy"></p>
<p>代码实现</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 接口</span>
<span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">ITeacherDao</span> <span class="token punctuation">{</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ProxyFactory</span> <span class="token punctuation">{</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="cglib-代理" tabindex="-1"><a class="header-anchor" href="#cglib-代理" aria-hidden="true">#</a> Cglib 代理</h2>
<h3 id="cglib-代理基本介绍" tabindex="-1"><a class="header-anchor" href="#cglib-代理基本介绍" aria-hidden="true">#</a> Cglib 代理基本介绍</h3>
<p>静态代理和 JDK 代理模式都要求目标对象是实现一个接口，但是有时候目标对象只是一个 <strong>单独的对象</strong>，并没有 <strong>实现任何的接口</strong>，这个时候可使用目标对象子类来实现代理，这就是 <strong>Cglib 代理</strong>。</p>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220325225355.png" alt="image-20220325225354561" loading="lazy"></p>
<blockquote>
<p>思路</p>
</blockquote>
<ol>
...
<li>
<p>创建增强器，相当于JDK动态代理需要的 父接口</p>
</li>
<li>
<p>设置要生成代理对象的目标对象的类</p>
</li>
<li>
<p>设置回调方法，里面指定生成目标对象的过程</p>
</li>
<li>
<p>执行生成目标对象</p>
</li>
...
<ul>
<li>我们已经写了一个对象，这个对象已经成型（目标对象）</li>
<li>时代变化，新功能出现，但是原来的对象成型，很难添加新的东西，于是我们需要重新造出一个对象</li>
<li>要求新的对象有旧的对象的所有功能，同时添加新的功能，于是需要 Proxy 动态代理（母亲）</li>
<li>怎么造出新对象呢，我们先造出代理对象的雏形（形状），然后给雏形找个父亲（目标对象的类）</li>
<li>让父亲和母亲造出新的对象，然后放进这个雏形（形状）里，并且在造出的过程添加新的功能，于是新的对象更加全面</li>
</ul>
<h3 id="cglib-代理模式应用实例" tabindex="-1"><a class="header-anchor" href="#cglib-代理模式应用实例" aria-hidden="true">#</a> Cglib 代理模式应用实例</h3>
<p>将前面的案例用 Cglib 代理模式实现。</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316220551.png" alt="image-20220316220549595" loading="lazy"></p>
<p>代码实现</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// Cglib 代理不需要接口</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">TeacherDao</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Cglib 代码类</p>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在内存中动态构建子类，注意代理的类不能为 final，否则报错 <code v-pre>java.lang.IllegalArgumentException</code>。</p>
<p>目标对象的方法如果为 final/static，那么就不会被拦截，即不会执行目标对象额外的业务方法。</p>
<h2 id="几种常见的代理模式介绍" tabindex="-1"><a class="header-anchor" href="#几种常见的代理模式介绍" aria-hidden="true">#</a> 几种常见的代理模式介绍</h2>
<blockquote>
<p>防火墙代理</p>
</blockquote>
...
<p>比如：当请求图片文件等资源时，先到缓存代理取，如果取到资源则 OK，如果取不到资源，再到公网或者数据库取，然后缓存。</p>
<blockquote>
<p>远程代理</p>
</blockquote>
...
<h2 id="代理模式的应用场景" tabindex="-1"><a class="header-anchor" href="#代理模式的应用场景" aria-hidden="true">#</a> 代理模式的应用场景</h2>
