<template><div><nav class="table-of-contents"><ul><li><router-link to="#模板方法模式基本介绍">模板方法模式基本介绍</router-link></li><li><router-link to="#模板方法模式结构与实现">模板方法模式结构与实现</router-link></li><li><router-link to="#模板方法模式解决豆浆制作问题">模板方法模式解决豆浆制作问题</router-link><ul><li><router-link to="#模板方法模式的钩子方法">模板方法模式的钩子方法</router-link></li></ul></li><li><router-link to="#模板方法模式的注意事项和细节">模板方法模式的注意事项和细节</router-link></li><li><router-link to="#模板方法模式的应用场景">模板方法模式的应用场景</router-link></li></ul></nav>
<h2 id="模板方法模式基本介绍" tabindex="-1"><a class="header-anchor" href="#模板方法模式基本介绍" aria-hidden="true">#</a> 模板方法模式基本介绍</h2>
...
<p><strong>模板方法模式</strong>（Template Method Pattern）又叫 <strong>模板模式</strong>（Template Pattern），在一个抽象类公开定义了执行它的方法的模板。它的子类可以按需要重写方法实现，但调用将以抽象类中定义的方式进行。</p>
<p>简单说，模板方法模式定义一个操作中的算法的骨架，而将一些步骤延迟到子类中，使得子类可以不改变一个算法的结构，就可以重定义该算法的某些特定步骤。</p>
...
<h2 id="模板方法模式结构与实现" tabindex="-1"><a class="header-anchor" href="#模板方法模式结构与实现" aria-hidden="true">#</a> 模板方法模式结构与实现</h2>
<p>模板方法模式包含以下主要角色。</p>
<blockquote>
<p>抽象类/抽象模板（Abstract Class）</p>
</blockquote>
...
<blockquote>
<p>具体子类/具体实现（Concrete Class）</p>
</blockquote>
<p>具体实现类，实现抽象类中所定义的抽象方法和钩子方法，它们是一个顶级逻辑的一个组成步骤。</p>
<p>模板方法模式的结构图如下：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326113625.png" alt="image-20220326113623976" loading="lazy"></p>
<p>代码实现：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 抽象类</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">TemplateMethodPattern</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="模板方法模式解决豆浆制作问题" tabindex="-1"><a class="header-anchor" href="#模板方法模式解决豆浆制作问题" aria-hidden="true">#</a> 模板方法模式解决豆浆制作问题</h2>
<p>编写制作豆浆的程序，说明如下：</p>
<ul>
<li>制作豆浆的流程：选材、添加配料、浸泡、放到豆浆机打碎</li>
<li>通过添加不同的配料，可以制作出不同口味的豆浆</li>
<li>选材、浸泡和放到豆浆机打碎这几个步骤对于制作每种口味的豆浆都是一样的（红豆、花生豆浆）</li>
<li>请使用 <strong>模板方法模式</strong> 完成</li>
</ul>
<p>思路分析和类图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326114123.png" alt="image-20220326114122266" loading="lazy"></p>
<h3 id="模板方法模式的钩子方法" tabindex="-1"><a class="header-anchor" href="#模板方法模式的钩子方法" aria-hidden="true">#</a> 模板方法模式的钩子方法</h3>
<p>在模板方法模式的父类中，我们可以定义一个方法，它默认不做任何事，子类可以视情况要不要覆盖它，该方法称为 <strong>钩子</strong>。</p>
<p>比如，我们还希望制作纯豆浆，不添加任何的配料，则使用钩子方法</p>
<p>代码实现：</p>
<p>抽象类</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 抽象类，表示豆浆</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="模板方法模式的注意事项和细节" tabindex="-1"><a class="header-anchor" href="#模板方法模式的注意事项和细节" aria-hidden="true">#</a> 模板方法模式的注意事项和细节</h2>
<p>基本思想是：算法只存在于一个地方，也就是在父类中，容易修改。需要修改算法时，只要修改父类的模板方法或者已经实现的某些步骤，子类就会继承这些修改。</p>
<p>实现了最大化代码复用。父类的模板方法和已实现的某些步骤会被子类继承而直接使用。既统一了算法，也提供了很大的灵活性。父类的模板方法确保了算法的结构保持不变，同时由子类提供部分步骤的实现。</p>
<p>该模式的不足之处：每一个不同的实现都需要一个子类实现，导致类的个数增加，使得系统更加庞大。一般模板方法都加上 final 关键字， 防止子类重写模板方法。</p>
<h2 id="模板方法模式的应用场景" tabindex="-1"><a class="header-anchor" href="#模板方法模式的应用场景" aria-hidden="true">#</a> 模板方法模式的应用场景</h2>
<p>模板方法模式通常适用于以下场景：</p>
<ul>
<li>
<p>算法的整体步骤很固定，但其中个别部分易变时，这时候可以使用模板方法模式，将容易变的部分抽象出来，供子类实现</p>
</li>
<li>
<p>当多个子类存在公共的行为时，可以将其提取出来并集中到一个公共父类中以避免代码重复。首先，要识别现有代码中的不同之处，并且将不同之处分离为新的操作。最后，用一个调用这些新的操作的模板方法来替换这些不同的代码</p>
</li>
<li>
<p>当需要控制子类的扩展时，模板方法只在特定点调用钩子操作，这样就只允许在这些点进行扩展</p>
</li>
</ul>
</div></template>
