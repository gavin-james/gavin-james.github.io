<template><div><nav class="table-of-contents"><ul><li><router-link to="#享元模式基本介绍">享元模式基本介绍</router-link></li><li><router-link to="#享元模式的结构与实现">享元模式的结构与实现</router-link><ul><li><router-link to="#内部状态和外部状态">内部状态和外部状态</router-link></li><li><router-link to="#模式的结构">模式的结构</router-link></li></ul></li><li><router-link to="#展示网站项目需求">展示网站项目需求</router-link></li><li><router-link to="#传统方案解决网站展现项目">传统方案解决网站展现项目</router-link><ul><li><router-link to="#问题分析">问题分析</router-link></li></ul></li><li><router-link to="#享元模式解决网站展现项目">享元模式解决网站展现项目</router-link></li><li><router-link to="#jdk-integer-的享元模式剖析">JDK-Integer 的享元模式剖析</router-link></li><li><router-link to="#享元模式的注意事项和细节">享元模式的注意事项和细节</router-link></li><li><router-link to="#享元模式的应用场景">享元模式的应用场景</router-link></li></ul></nav>
<h2 id="享元模式基本介绍" tabindex="-1"><a class="header-anchor" href="#享元模式基本介绍" aria-hidden="true">#</a> 享元模式基本介绍</h2>
...
<p><strong>享元模式</strong>（Flyweight Pattern） 也叫 <strong>蝇量模式</strong>: 运用共享技术有效地支持大量细粒度的对象。</p>
...
<h2 id="享元模式的结构与实现" tabindex="-1"><a class="header-anchor" href="#享元模式的结构与实现" aria-hidden="true">#</a> 享元模式的结构与实现</h2>
<h3 id="内部状态和外部状态" tabindex="-1"><a class="header-anchor" href="#内部状态和外部状态" aria-hidden="true">#</a> 内部状态和外部状态</h3>
...
<ul>
<li>
<p>内部状态指对象共享出来的信息，存储在享元信息内部，并且不会随环境的改变而改变</p>
</li>
<li>
<p>外部状态指对象得以依赖的一个标记，随环境的改变而改变，不可共享
比如，连接池中的连接对象，保存在连接对象中的用户名、密码、连接 URL 等信息，在创建对象的时候就设置好了，不会随环境的改变而改变，这些为内部状态。而当每个连接要被回收利用时，我们需要将它标记为可用状态，这些为外部状态</p>
</li>
</ul>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213417.png" alt="image-20220314190648003" loading="lazy"></p>
<p>下面享元模式的结构图，其中：</p>
<ul>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213419.png" alt="image-20220314190636066" loading="lazy"></p>
<p>代码实现：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 抽象享元角色</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FlyweightPattern</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="展示网站项目需求" tabindex="-1"><a class="header-anchor" href="#展示网站项目需求" aria-hidden="true">#</a> 展示网站项目需求</h2>
...
<h2 id="传统方案解决网站展现项目" tabindex="-1"><a class="header-anchor" href="#传统方案解决网站展现项目" aria-hidden="true">#</a> 传统方案解决网站展现项目</h2>
<p>给每个网站租用一个空间。</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213422.png" alt="image-20220314190248901" loading="lazy"></p>
<h3 id="问题分析" tabindex="-1"><a class="header-anchor" href="#问题分析" aria-hidden="true">#</a> 问题分析</h3>
<p>需要的网站结构相似度很高，而且都不是高访问量网站，如果分成多个虚拟空间来处理，相当于一个相同网站的实例对象很多，造成服务器的资源浪费。</p>
<p>解决思路：整合到一个网站中，共享其相关的代码和数据，对于硬盘、内存、CPU、数据库空间等服务器资源 都可以达成共享，减少服务器资源。</p>
<p>对于代码来说，由于是一份实例，维护和扩展都更加容易。</p>
<p>上面的解决思路就可以使用 <strong>享元模式</strong>。</p>
<h2 id="享元模式解决网站展现项目" tabindex="-1"><a class="header-anchor" href="#享元模式解决网站展现项目" aria-hidden="true">#</a> 享元模式解决网站展现项目</h2>
<p>类图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213425.png" alt="image-20220314190856461" loading="lazy"></p>
<p>代码实现：</p>
<p>User 类：</p>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">WebSite</span> <span class="token punctuation">{</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 网站工厂类，根据需要返回压一个网站</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="jdk-integer-的享元模式剖析" tabindex="-1"><a class="header-anchor" href="#jdk-integer-的享元模式剖析" aria-hidden="true">#</a> JDK-Integer 的享元模式剖析</h2>
<p>JDK 中 Integer 使用到了享元模式。</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213452.png" alt="image-20220314191251956" loading="lazy"></p>
<p>代码说明：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FlyWeight</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="享元模式的注意事项和细节" tabindex="-1"><a class="header-anchor" href="#享元模式的注意事项和细节" aria-hidden="true">#</a> 享元模式的注意事项和细节</h2>
<ul>
<li>在享元模式这样理解，「享」就表示共享，「元」表示对象</li>
<li>系统中有大量对象，这些对象消耗大量内存，并且对象的状态大部分可以外部化时，我们就可以考虑选用享元模式</li>
<li>用唯一标识码判断，如果在内存中有，则返回这个唯一标识码所标识的对象，用 <code v-pre>HashMap/HashTable</code> 存储</li>
...
<h2 id="享元模式的应用场景" tabindex="-1"><a class="header-anchor" href="#享元模式的应用场景" aria-hidden="true">#</a> 享元模式的应用场景</h2>
<p>当系统中多处需要同一组信息时，可以把这些信息封装到一个对象中，然后对该对象进行缓存，这样，一个对象就可以提供给多出需要使用的地方，避免大量同一对象的多次创建，降低大量内存空间的消耗。</p>
<p>享元模式其实是 <a href="https://notes.gavin.cn/design-pattern/factory/#%E5%B7%A5%E5%8E%82%E6%96%B9%E6%B3%95-factory-method" target="_blank" rel="noopener noreferrer">工厂方法模式<ExternalLinkIcon/></a> 的一个改进机制，享元模式同样要求创建一个或一组对象，并且就是通过工厂方法模式生成对象的，只不过享元模式为工厂方法模式增加了缓存这一功能。</p>
