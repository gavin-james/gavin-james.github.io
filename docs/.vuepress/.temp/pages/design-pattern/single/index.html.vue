<template><div><nav class="table-of-contents"><ul><li><router-link to="#单例设计模式介绍">单例设计模式介绍</router-link></li><li><router-link to="#单例设计模式八种方式">单例设计模式八种方式</router-link><ul><li><router-link to="#饿汉式-静态常量">饿汉式（静态常量）</router-link></li><li><router-link to="#饿汉式-静态代码块">饿汉式（静态代码块）</router-link></li><li><router-link to="#懒汉式-线程不安全">懒汉式（线程不安全）</router-link></li><li><router-link to="#懒汉式-线程安全-同步方法">懒汉式（线程安全，同步方法）</router-link></li><li><router-link to="#懒汉式-线程安全-同步代码块">懒汉式（线程安全，同步代码块）</router-link></li><li><router-link to="#双重检查">双重检查</router-link></li><li><router-link to="#静态内部类">静态内部类</router-link></li><li><router-link to="#枚举">枚举</router-link></li></ul></li><li><router-link to="#单例模式jdk应用">单例模式JDK应用</router-link></li><li><router-link to="#单例模式注意事项和细节说明">单例模式注意事项和细节说明</router-link></li><li><router-link to="#单例模式的应用场景">单例模式的应用场景</router-link></li><li><router-link to="#单例存在哪些问题">单例存在哪些问题</router-link><ul><li><router-link to="#单例对-oop-特性的支持不友好">单例对 OOP 特性的支持不友好</router-link></li><li><router-link to="#单例会隐藏类之间的依赖关系">单例会隐藏类之间的依赖关系</router-link></li><li><router-link to="#单例对代码的扩展性不友好">单例对代码的扩展性不友好</router-link></li><li><router-link to="#单例对代码的可测试性不友好">单例对代码的可测试性不友好</router-link></li><li><router-link to="#单例不支持有参数的构造函数">单例不支持有参数的构造函数</router-link></li></ul></li><li><router-link to="#有何替代解决方案">有何替代解决方案</router-link></li><li><router-link to="#如何理解单例模式中的唯一性">如何理解单例模式中的唯一性</router-link></li><li><router-link to="#如何实现线程唯一的单例">如何实现线程唯一的单例</router-link></li><li><router-link to="#如何实现集群环境下的单例">如何实现集群环境下的单例？</router-link></li><li><router-link to="#如何实现一个多例模式">如何实现一个多例模式？</router-link></li></ul></nav>
<h2 id="单例设计模式介绍" tabindex="-1"><a class="header-anchor" href="#单例设计模式介绍" aria-hidden="true">#</a> 单例设计模式介绍</h2>
