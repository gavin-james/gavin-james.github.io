<template><div><nav class="table-of-contents"><ul><li><router-link to="#外观模式基本介绍">外观模式基本介绍</router-link></li><li><router-link to="#外观模式的结构与实现">外观模式的结构与实现</router-link><ul><li><router-link to="#模式的结构">模式的结构</router-link></li><li><router-link to="#模式的实现">模式的实现</router-link></li></ul></li><li><router-link to="#影院管理项目">影院管理项目</router-link></li><li><router-link to="#传统方式解决影院管理">传统方式解决影院管理</router-link><ul><li><router-link to="#传统方式解决问题图">传统方式解决问题图</router-link></li><li><router-link to="#传统方式解决问题分析">传统方式解决问题分析</router-link></li></ul></li><li><router-link to="#外观模式解决影院管理">外观模式解决影院管理</router-link></li><li><router-link to="#mybatis-框架的外观模式剖析">MyBatis 框架的外观模式剖析</router-link></li><li><router-link to="#外观模式的注意事项和细节">外观模式的注意事项和细节</router-link></li><li><router-link to="#外观模式的应用场景">外观模式的应用场景</router-link></li></ul></nav>
<h2 id="外观模式基本介绍" tabindex="-1"><a class="header-anchor" href="#外观模式基本介绍" aria-hidden="true">#</a> 外观模式基本介绍</h2>
...
<p><strong>外观模式</strong>（Facade Pattern），也叫 <strong>过程模式</strong>、<strong>门面模式</strong>，是一种通过为多个复杂的子系统提供一个一致的接口，而使这些子系统更加容易被访问的模式。该模式对外有一个统一接口，外部应用程序不用关心内部子系统的具体细节，这样会大大降低应用程序的复杂度，提高了程序的可维护性。</p>
...
<li>增加新的子系统可能需要修改外观类或客户端的源代码，违背了 <strong>开闭原则</strong></li>
</ul>
<h2 id="外观模式的结构与实现" tabindex="-1"><a class="header-anchor" href="#外观模式的结构与实现" aria-hidden="true">#</a> 外观模式的结构与实现</h2>
<p>外观（Facade）模式的结构比较简单，主要是定义了一个高层接口。它包含了对各个子系统的引用，客户端可以通过它访问各个子系统的功能。现在来分析其基本结构和实现方法。</p>
<h3 id="模式的结构" tabindex="-1"><a class="header-anchor" href="#模式的结构" aria-hidden="true">#</a> 模式的结构</h3>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314175540.png" alt="image-20220314175538719" loading="lazy"></p>
<h3 id="模式的实现" tabindex="-1"><a class="header-anchor" href="#模式的实现" aria-hidden="true">#</a> 模式的实现</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 子系统角色</span>
...
<span class="token keyword">class</span> <span class="token class-name">Facade</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
<span class="token comment">// 客户角色</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FacadePattern</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="影院管理项目" tabindex="-1"><a class="header-anchor" href="#影院管理项目" aria-hidden="true">#</a> 影院管理项目</h2>
<p>组建一个家庭影院：DVD 播放器、投影仪、自动屏幕、环绕立体声、爆米花机，灯光。</p>
<p>过程：开爆米花机、开爆米花机、开投影仪、开音响、开 DVD、选 DVD、去拿爆米花、调暗灯光、播放、观影结束后，关闭各种设备。</p>
<h2 id="传统方式解决影院管理" tabindex="-1"><a class="header-anchor" href="#传统方式解决影院管理" aria-hidden="true">#</a> 传统方式解决影院管理</h2>
<h3 id="传统方式解决问题图" tabindex="-1"><a class="header-anchor" href="#传统方式解决问题图" aria-hidden="true">#</a> 传统方式解决问题图</h3>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314175113.png" alt="image-20220314175108493" loading="lazy"></p>
<h3 id="传统方式解决问题分析" tabindex="-1"><a class="header-anchor" href="#传统方式解决问题分析" aria-hidden="true">#</a> 传统方式解决问题分析</h3>
<p>在 ClientTest 的 main 方法中，创建各个子系统的对象，并直接去调用子系统(对象)相关方法，会造成调用过程混乱，没有清晰的过程，不利于在 ClientTest 中，去维护对子系统的操作</p>
<p>解决思路：定义一个高层接口，给子系统中的一组接口提供一个一致的界面（比如在高层接口提供四个方法 ready, play, pause, end），用来访问子系统中的一群接口。</p>
<p>也就是说就是通过定义一个一致的接口（界面类），用以屏蔽内部子系统的细节，使得调用端只需跟这个接口发生调用，而无需关心这个子系统的内部细节，即使用 <strong>外观模式</strong>。</p>
<h2 id="外观模式解决影院管理" tabindex="-1"><a class="header-anchor" href="#外观模式解决影院管理" aria-hidden="true">#</a> 外观模式解决影院管理</h2>
<p>外观模式可以理解为转换一群接口，客户只要调用一个接口，而不用调用多个接口才能达到目的。比如：在 PC 上安装软件的时候经常有一键安装选项（省去选择安装目录、安装的组件等等），还有就是手机的重启功能（把关机和启动合为一个操作）。</p>
<p>外观模式就是解决多个复杂接口带来的使用困难，起到简化用户操作的作用。</p>
<p>示意图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314175731.png" alt="image-20220314175728964" loading="lazy"></p>
<p>影院管理项目类图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314175755.png" alt="image-20220314175754422" loading="lazy"></p>
<p>代码示例：</p>
<p>影院的 DVD 播放器、投影仪、自动屏幕、环绕立体声、爆米花机、灯光类</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// DVD 播放器</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">DVDPlayer</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
<span class="token comment">// 投影仪</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Projector</span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">//...</span>
<span class="token punctuation">}</span>
<span class="token comment">// 自动屏幕</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Screen</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
<span class="token comment">// 爆米花机</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Popcorn</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
<span class="token comment">// 环绕立体声</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HomeTheaterFacade</span> <span class="token punctuation">{</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="mybatis-框架的外观模式剖析" tabindex="-1"><a class="header-anchor" href="#mybatis-框架的外观模式剖析" aria-hidden="true">#</a> MyBatis 框架的外观模式剖析</h2>
<p>MyBatis 中的 Configuration 去创建 MetaObject 对象使用到外观模式。</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314180359.png" alt="image-20220314180358602" loading="lazy"></p>
<p>对源码中使用到的外观模式的角色类图</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314180444.png" alt="image-20220314180442486" loading="lazy"></p>
<h2 id="外观模式的注意事项和细节" tabindex="-1"><a class="header-anchor" href="#外观模式的注意事项和细节" aria-hidden="true">#</a> 外观模式的注意事项和细节</h2>
<ul>
<li>
<p>外观模式 <strong>对外屏蔽了子系统的细节</strong>，因此外观模式降低了客户端对子系统使用的复杂性</p>
</li>
<li>
<p>外观模式对客户端与子系统的耦合关系：解耦，让子系统内部的模块更易维护和扩展</p>
</li>
<li>
<p>通过合理的使用外观模式，可以帮我们更好的 <strong>划分访问的层次</strong></p>
</li>
<li>
<p>当系统需要进行分层设计时，可以考虑使用 Facade 模式</p>
</li>
<li>
<p>在维护一个遗留的大型系统时，可能这个系统已经变得非常难以维护和扩展，此时可以考虑为新系统开发一个 Facade 类，来提供遗留系统的比较清晰简单的接口，让新系统与 Facade 类交互，提高复用性</p>
</li>
<li>
<p>不能过多的或者不合理的使用外观模式，使用外观模式好，还是直接调用模块好。要以让系统有层次，利于维护为目的</p>
</li>
</ul>
<h2 id="外观模式的应用场景" tabindex="-1"><a class="header-anchor" href="#外观模式的应用场景" aria-hidden="true">#</a> 外观模式的应用场景</h2>
...
<li>
<p>当客户端与多个子系统之间存在很大的联系时，引入外观模式可将它们分离，从而提高子系统的独立性和可移植性</p>
</li>
</ul>
</div></template>
