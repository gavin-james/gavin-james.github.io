<template><div><nav class="table-of-contents"><ul><li><router-link to="#解释器模式基本介绍">解释器模式基本介绍</router-link></li><li><router-link to="#解释器模式的结构与实现">解释器模式的结构与实现</router-link></li><li><router-link to="#四则运算问题">四则运算问题</router-link></li><li><router-link to="#解释器模式来实现四则">解释器模式来实现四则</router-link></li><li><router-link to="#解释器模式的注意事项和细节">解释器模式的注意事项和细节</router-link></li><li><router-link to="#解释器模式的应用场景">解释器模式的应用场景</router-link></li></ul></nav>
<h2 id="解释器模式基本介绍" tabindex="-1"><a class="header-anchor" href="#解释器模式基本介绍" aria-hidden="true">#</a> 解释器模式基本介绍</h2>
...
<p>解释器模式的结构图如下图所示：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326171644.png" alt="image-20220326171643437" loading="lazy"></p>
<p>代码实现：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 抽象表达式类</span>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>请输入表达式：a+b+c-d+e
请输入a的值：10
请输入b的值：11
请输入c的值：1
请输入d的值：2
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326170940.png" alt="image-20220326170939660" loading="lazy"></p>
<h2 id="解释器模式来实现四则" tabindex="-1"><a class="header-anchor" href="#解释器模式来实现四则" aria-hidden="true">#</a> 解释器模式来实现四则</h2>
<p>思路分析和类图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326171910.png" alt="image-20220326171909429" loading="lazy"></p>
<p>代码实现：</p>
<p>解释器类</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 抽象类表达式，通过 HashMap 键值对, 可以获取到变量的值</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Calculator</span> <span class="token punctuation">{</span>
