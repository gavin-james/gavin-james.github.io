<template><div><nav class="table-of-contents"><ul><li><router-link to="#原型模式基本介绍">原型模式基本介绍</router-link></li><li><router-link to="#原型模式原理结构图">原型模式原理结构图</router-link></li><li><router-link to="#克隆羊案例">克隆羊案例</router-link></li><li><router-link to="#传统方式解决克隆羊实例">传统方式解决克隆羊实例</router-link></li><li><router-link to="#传统的方式的优缺点">传统的方式的优缺点</router-link></li><li><router-link to="#原型模式解决克隆羊实例">原型模式解决克隆羊实例</router-link></li><li><router-link to="#spring-框架的原型模式">Spring 框架的原型模式</router-link></li><li><router-link to="#深入讨论-浅拷贝和深拷贝">深入讨论：浅拷贝和深拷贝</router-link></li><li><router-link to="#原型模式的注意事项和细节">原型模式的注意事项和细节</router-link></li></ul></nav>
