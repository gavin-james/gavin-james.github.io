<template><div><nav class="table-of-contents"><ul><li><router-link to="#基本介绍">基本介绍</router-link></li><li><router-link to="#模式的结构">模式的结构</router-link></li><li><router-link to="#工作原理">工作原理</router-link></li><li><router-link to="#现实生活中的适配器例子">现实生活中的适配器例子</router-link></li><li><router-link to="#类适配器模式">类适配器模式</router-link><ul><li><router-link to="#类适配器模式介绍">类适配器模式介绍</router-link></li><li><router-link to="#类适配器模式应用实例">类适配器模式应用实例</router-link></li><li><router-link to="#类适配器模式注意事项和细节">类适配器模式注意事项和细节</router-link></li></ul></li><li><router-link to="#对象适配器模式">对象适配器模式</router-link><ul><li><router-link to="#对象适配器模式介绍">对象适配器模式介绍</router-link></li><li><router-link to="#对象适配器模式应用实例">对象适配器模式应用实例</router-link></li><li><router-link to="#对象适配器模式注意事项和细节">对象适配器模式注意事项和细节</router-link></li></ul></li><li><router-link to="#接口适配器模式">接口适配器模式</router-link><ul><li><router-link to="#接口适配器模式介绍">接口适配器模式介绍</router-link></li><li><router-link to="#接口适配器模式应用实例">接口适配器模式应用实例</router-link></li></ul></li><li><router-link to="#springmvc-的适配器模式剖析">SpringMVC 的适配器模式剖析</router-link></li><li><router-link to="#适配器模式的注意事项和细节">适配器模式的注意事项和细节</router-link></li><li><router-link to="#适配器模式的应用场景">适配器模式的应用场景</router-link></li></ul></nav>
...
<p><strong>适配器模式</strong>（Adapter Pattern）将某个类的接口转换成客户端期望的另一个接口表示，主的目的是兼容性，让原本因接口不匹配不能一起工作的两个类可以协同工作。其别名为包装器（Wrapper）。</p>
<p>适配器模式属于结构型模式，主要分为三类：类适配器模式、对象适配器模式、接口适配器模式。</p>
<blockquote>
<p>主要优点</p>
</blockquote>
<ul>
...
<h2 id="模式的结构" tabindex="-1"><a class="header-anchor" href="#模式的结构" aria-hidden="true">#</a> 模式的结构</h2>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172447.png" alt="image-20220307113733499" loading="lazy"></p>
</li>
</ul>
<h2 id="现实生活中的适配器例子" tabindex="-1"><a class="header-anchor" href="#现实生活中的适配器例子" aria-hidden="true">#</a> 现实生活中的适配器例子</h2>
<p>泰国插座用的是两孔的（欧标），可以买个多功能转换插头 (适配器) ，这样就可以使用了。</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172337.png" alt="image-20220307113604066" loading="lazy"></p>
<h2 id="类适配器模式" tabindex="-1"><a class="header-anchor" href="#类适配器模式" aria-hidden="true">#</a> 类适配器模式</h2>
<h3 id="类适配器模式介绍" tabindex="-1"><a class="header-anchor" href="#类适配器模式介绍" aria-hidden="true">#</a> 类适配器模式介绍</h3>
<p>基本介绍：Adapter 类，通过继承 <strong>被适配类</strong>，实现 <strong>适配接口</strong>，完成被适配类到适配接口的适配。</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172519.png" alt="image-20220314150218744" loading="lazy"></p>
<h3 id="类适配器模式应用实例" tabindex="-1"><a class="header-anchor" href="#类适配器模式应用实例" aria-hidden="true">#</a> 类适配器模式应用实例</h3>
<p>应用实例说明：以生活中充电器的例子来讲解适配器，充电器本身相当于 Adapter，220V 交流电相当于 src（即被适配者），我们的目标是 5V 直流电。</p>
<p>思路分析（类图）：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172450.png" alt="image-20220307113851301" loading="lazy"></p>
<p>代码实现</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// dst 适配接口（充电器需要 5V）</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="类适配器模式注意事项和细节" tabindex="-1"><a class="header-anchor" href="#类适配器模式注意事项和细节" aria-hidden="true">#</a> 类适配器模式注意事项和细节</h3>
<ul>
<li>Java 是单继承机制，所以类适配器需要继承 src（被适配类）类这一点算是一个缺点，因为这要求 dst（适配接口） 必须是接口，有一定局限性</li>
...
<h3 id="对象适配器模式介绍" tabindex="-1"><a class="header-anchor" href="#对象适配器模式介绍" aria-hidden="true">#</a> 对象适配器模式介绍</h3>
<p>基本思路和类的适配器模式相同，只是将 Adapter 类作修改，不是继承 src 类，而是持有 src 类的实例，以解决兼容性的问题。即：持有 src 类，实现 dst 类接口，完成 src 到 dst 的适配。</p>
<p>根据「<strong>合成复用原则</strong>」，在系统中尽量使用 <strong>关联关系（聚合）来替代继承</strong> 关系。</p>
<p>对象适配器模式是适配器模式常用的一种。</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172454.png" alt="image-20220314150231277" loading="lazy"></p>
<h3 id="对象适配器模式应用实例" tabindex="-1"><a class="header-anchor" href="#对象适配器模式应用实例" aria-hidden="true">#</a> 对象适配器模式应用实例</h3>
<blockquote>
<p>应用实例说明</p>
</blockquote>
<p>以生活中充电器的例子来讲解适配器，充电器本身相当于 Adapter，220V 交流电相当于 src (即被适配者)，我们的 dst（即目标）是 5V 直流电，使用对象适配器模式完成。</p>
<blockquote>
<p>思路分析（类图）</p>
</blockquote>
<p>只需修改适配器即可，如下：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172456.png" alt="image-20220307153329627" loading="lazy"></p>
<blockquote>
<p>代码实现</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 适配接口（充电器需要 5V）</span>
<span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">IVoltage5V</span> <span class="token punctuation">{</span>
	<span class="token keyword">public</span> <span class="token keyword">int</span> <span class="token function">output5V</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="对象适配器模式注意事项和细节" tabindex="-1"><a class="header-anchor" href="#对象适配器模式注意事项和细节" aria-hidden="true">#</a> 对象适配器模式注意事项和细节</h3>
<ul>
<li>
<p>对象适配器和类适配器其实算是同一种思想，只不过实现方式不同。根据合成复用原则，使用组合替代继承，所以它解决了类适配器必须继承 src 的局限性问题，也不再要求 dst 必须是接口</p>
</li>
<li>
<p>使用成本更低，更灵活</p>
</li>
</ul>
<h2 id="接口适配器模式" tabindex="-1"><a class="header-anchor" href="#接口适配器模式" aria-hidden="true">#</a> 接口适配器模式</h2>
<h3 id="接口适配器模式介绍" tabindex="-1"><a class="header-anchor" href="#接口适配器模式介绍" aria-hidden="true">#</a> 接口适配器模式介绍</h3>
<ul>
...
<h3 id="接口适配器模式应用实例" tabindex="-1"><a class="header-anchor" href="#接口适配器模式应用实例" aria-hidden="true">#</a> 接口适配器模式应用实例</h3>
<ul>
<li>
<p>Android 中的属性动画 ValueAnimator 类可以通过 <code v-pre>addListener(AnimatorListener listener)</code> 方法添加监听器，那么常规写法如下：</p>
...
<li>
<p>有时候我们不想实现 <code v-pre>Animator.AnimatorListener</code> 接口的全部方法，我们只想监听 onAnimationStart，我们会如下写：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">ValueAnimator</span> valueAnimator <span class="token operator">=</span> <span class="token class-name">ValueAnimator</span><span class="token punctuation">.</span><span class="token function">oflnt</span><span class="token punctuation">(</span><span class="token number">0</span><span class="token punctuation">,</span><span class="token number">100</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<li>
<p>AnimatorListenerAdapter 类，就是一个接口适配器，代码如下：它空实现了 Animator.AnimatorListener 类(src)的所有方法</p>
...
<li>
<p>AnimatorListener 是一个接口：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">interface</span> <span class="token class-name">AnimatorListener</span> <span class="token punctuation">{</span>
...
<li>
<p>程序里的匿名内部类就是 Listener 具体实现类</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">new</span> <span class="token class-name">AnimatorListenerAdapter</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    <span class="token annotation punctuation">@Override</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">onAnimationStart</span><span class="token punctuation">(</span><span class="token class-name">Animator</span> animation<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">// xxxx 具体实现</span>
    <span class="token punctuation">}</span>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172506.png" alt="image-20220307154814117" loading="lazy"></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">Interface4</span> <span class="token punctuation">{</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="springmvc-的适配器模式剖析" tabindex="-1"><a class="header-anchor" href="#springmvc-的适配器模式剖析" aria-hidden="true">#</a> SpringMVC 的适配器模式剖析</h2>
<ul>
<li>
<p>SpringMVC 中的 HandlerAdapter, 就使用了适配器模式</p>
</li>
<li>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172509.png" alt="image-20220307155052736" loading="lazy"></p>
<h2 id="适配器模式的注意事项和细节" tabindex="-1"><a class="header-anchor" href="#适配器模式的注意事项和细节" aria-hidden="true">#</a> 适配器模式的注意事项和细节</h2>
<ul>
<li>三种命名方式，是根据 src 是以怎样的形式给到 Adapter（在 Adapter 里的形式）来命名的</li>
<li>类适配器：以类给到，在 Adapter 里，就是将 src 当做类，继承
<ul>
...
<h2 id="适配器模式的应用场景" tabindex="-1"><a class="header-anchor" href="#适配器模式的应用场景" aria-hidden="true">#</a> 适配器模式的应用场景</h2>
