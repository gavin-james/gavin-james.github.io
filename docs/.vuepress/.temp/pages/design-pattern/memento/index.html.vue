<template><div><nav class="table-of-contents"><ul><li><router-link to="#备忘录模式基本介绍">备忘录模式基本介绍</router-link></li><li><router-link to="#备忘录模式的结构与实现">备忘录模式的结构与实现</router-link></li><li><router-link to="#游戏角色状态恢复问题">游戏角色状态恢复问题</router-link></li><li><router-link to="#传统方案解决游戏角色恢复">传统方案解决游戏角色恢复</router-link></li><li><router-link to="#备忘录模式解决游戏角色恢复">备忘录模式解决游戏角色恢复</router-link></li><li><router-link to="#备忘录模式的注意事项和细节">备忘录模式的注意事项和细节</router-link></li><li><router-link to="#备忘录模式的应用场景">备忘录模式的应用场景</router-link></li></ul></nav>
<h2 id="备忘录模式基本介绍" tabindex="-1"><a class="header-anchor" href="#备忘录模式基本介绍" aria-hidden="true">#</a> 备忘录模式基本介绍</h2>
...
<h2 id="备忘录模式的结构与实现" tabindex="-1"><a class="header-anchor" href="#备忘录模式的结构与实现" aria-hidden="true">#</a> 备忘录模式的结构与实现</h2>
<p>备忘录模式的核心是设计备忘录类以及用于管理备忘录的管理者类。</p>
<p>备忘录模式的主要角色如下：</p>
<ul>
...
<p>备忘录模式的结构图如下图所示：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326165254.png" alt="image-20220326165253607" loading="lazy"></p>
<p>代码实现：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 备忘录</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MementoPattern</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="游戏角色状态恢复问题" tabindex="-1"><a class="header-anchor" href="#游戏角色状态恢复问题" aria-hidden="true">#</a> 游戏角色状态恢复问题</h2>
<p>游戏角色有攻击力和防御力，在大战 Boss 前保存自身的状态（攻击力和防御力），当大战 Boss 后攻击力和防御力下降，从备忘录对象恢复到大战前的状态。</p>
<h2 id="传统方案解决游戏角色恢复" tabindex="-1"><a class="header-anchor" href="#传统方案解决游戏角色恢复" aria-hidden="true">#</a> 传统方案解决游戏角色恢复</h2>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326164848.png" alt="image-20220326164847860" loading="lazy"></p>
<p>一个对象，就对应一个保存对象状态的对象，这样当我们游戏的对象很多时，不利于管理，开销也很大。</p>
<p>传统的方式是简单地做备份，new 出另外一个对象出来，再把需要备份的数据放到这个新对象，但这就暴露了对象内部的细节</p>
<p>解决方案：<strong>备忘录模式</strong>。</p>
<h2 id="备忘录模式解决游戏角色恢复" tabindex="-1"><a class="header-anchor" href="#备忘录模式解决游戏角色恢复" aria-hidden="true">#</a> 备忘录模式解决游戏角色恢复</h2>
<p>思路分析和类图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326165602.png" alt="image-20220326165601510" loading="lazy"></p>
<p>代码实现：</p>
<p>备忘录类</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Memento</span> <span class="token punctuation">{</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 守护者对象, 保存游戏角色的状态</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">GameRole</span> <span class="token punctuation">{</span>

    <span class="token keyword">private</span> <span class="token keyword">int</span> vit<span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">int</span> def<span class="token punctuation">;</span>

    <span class="token comment">// 创建 Memento ,即根据当前的状态得到 Memento</span>
    <span class="token keyword">public</span> <span class="token class-name">Memento</span> <span class="token function">createMemento</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">// 从备忘录对象，恢复 GameRole 的状态</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token comment">// 把当前状态保存 caretaker</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="备忘录模式的注意事项和细节" tabindex="-1"><a class="header-anchor" href="#备忘录模式的注意事项和细节" aria-hidden="true">#</a> 备忘录模式的注意事项和细节</h2>
<ul>
<li>备忘录模式给用户提供了一种可以恢复状态的机制，可以使用户能够比较方便地回到某个历史的状态</li>
<li>备忘录模式实现了信息的封装，使得用户不需要关心状态的保存细节</li>
<li>如果类的成员变量过多，势必会占用比较大的资源，而且每一次保存都会消耗一定的内存，这个需要注意</li>
<li>为了节约内存，备忘录模式可以和原型模式配合使用</li>
</ul>
<h2 id="备忘录模式的应用场景" tabindex="-1"><a class="header-anchor" href="#备忘录模式的应用场景" aria-hidden="true">#</a> 备忘录模式的应用场景</h2>
