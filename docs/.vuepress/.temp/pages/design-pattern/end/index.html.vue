<template><div><nav class="table-of-contents"><ul><li><router-link to="#总结">总结</router-link><ul><li><router-link to="#创建型设计模式">创建型设计模式</router-link></li><li><router-link to="#结构型设计模式">结构型设计模式</router-link></li><li><router-link to="#行为型设计模式">行为型设计模式</router-link></li></ul></li></ul></nav>
...
<p>来自：<code v-pre>http://c.biancheng.net/view/8462.html</code>。</p>
</div></template>
