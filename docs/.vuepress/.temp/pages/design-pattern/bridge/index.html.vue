<template><div><nav class="table-of-contents"><ul><li><router-link to="#桥接模式基本介绍">桥接模式基本介绍</router-link></li><li><router-link to="#桥接模式的结构与实现">桥接模式的结构与实现</router-link></li><li><router-link to="#手机操作问题">手机操作问题</router-link></li><li><router-link to="#传统方案解决手机操作问题">传统方案解决手机操作问题</router-link><ul><li><router-link to="#传统方案解决手机操作问题分析">传统方案解决手机操作问题分析</router-link></li></ul></li><li><router-link to="#桥接模式解决手机操作问题">桥接模式解决手机操作问题</router-link></li><li><router-link to="#jdbc-的桥接模式剖析">JDBC 的桥接模式剖析</router-link></li><li><router-link to="#桥接模式的注意事项和细节">桥接模式的注意事项和细节</router-link></li><li><router-link to="#桥接模式的应用场景">桥接模式的应用场景</router-link></li><li><router-link to="#常见的应用场景">常见的应用场景</router-link></li><li><router-link to="#桥接模式模式的扩展">桥接模式模式的扩展</router-link></li></ul></nav>
<h2 id="桥接模式基本介绍" tabindex="-1"><a class="header-anchor" href="#桥接模式基本介绍" aria-hidden="true">#</a> 桥接模式基本介绍</h2>
...
<p><strong>桥接模式</strong>（Bridge Pattern）是指：将实现与抽象放在两个不同的类层次中，使两个层次可以独立改变，是一种结构型设计模式。</p>
<p><strong>桥接模式</strong> 基于类的最小设计原则，通过使用封装、聚合及继承等行为让不同的类承担不同的职责。它的主要特点是把抽象（Abstraction）与行为实现（Implementation）分离开来，从而可以保持各部分的独立性以及应对他们的功能扩展。</p>
<blockquote>
<p>主要优点</p>
</blockquote>
<ul>
...
<h2 id="桥接模式的结构与实现" tabindex="-1"><a class="header-anchor" href="#桥接模式的结构与实现" aria-hidden="true">#</a> 桥接模式的结构与实现</h2>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172534.png" alt="image-20220314154132216" loading="lazy"></p>
<p>上面图片桥接模式的代码如下：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 实现化角色</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">BridgeTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="手机操作问题" tabindex="-1"><a class="header-anchor" href="#手机操作问题" aria-hidden="true">#</a> 手机操作问题</h2>
<p>现在对不同手机类型的不同品牌实现操作编程（比如:开机、关机、上网，打电话等），如图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172530.png" alt="image-20220314153744545" loading="lazy"></p>
<h2 id="传统方案解决手机操作问题" tabindex="-1"><a class="header-anchor" href="#传统方案解决手机操作问题" aria-hidden="true">#</a> 传统方案解决手机操作问题</h2>
<p>传统方法对应的类图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172532.png" alt="image-20220314153823688" loading="lazy"></p>
<h3 id="传统方案解决手机操作问题分析" tabindex="-1"><a class="header-anchor" href="#传统方案解决手机操作问题分析" aria-hidden="true">#</a> 传统方案解决手机操作问题分析</h3>
<p>扩展性问题（类爆炸），如果我们再增加手机的样式（旋转式），就需要增加各个品牌手机的类，同样如果我们增加一个手机品牌，也要在各个手机样式类下增加。</p>
<p>违反了单一职责原则，当我们增加手机样式时，要同时增加所有品牌的手机，这样增加了代码维护成本。</p>
<p>解决方案：<strong>使用桥接模式</strong>。</p>
<h2 id="桥接模式解决手机操作问题" tabindex="-1"><a class="header-anchor" href="#桥接模式解决手机操作问题" aria-hidden="true">#</a> 桥接模式解决手机操作问题</h2>
<p>使用桥接模式改进传统方式，让程序具有搞好的扩展性，利用程序维护。</p>
<p>使用桥接模式对应的类图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172536.png" alt="image-20220314154311971" loading="lazy"></p>
<p>代码示例：</p>
<p>手机品牌代码</p>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Phone</span> <span class="token punctuation">{</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FoldedPhone</span> <span class="token keyword">extends</span> <span class="token class-name">Phone</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
<span class="token comment">// 直立样式手机</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Client</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="jdbc-的桥接模式剖析" tabindex="-1"><a class="header-anchor" href="#jdbc-的桥接模式剖析" aria-hidden="true">#</a> JDBC 的桥接模式剖析</h2>
<p>JDBC 的 Driver 接口，如果从桥接模式来看，Driver 就是一个接口，下面可以有 MySQL 的 Driver，Oracle 的 Driver，这些就可以当做实现接口类。</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172540.png" alt="image-20220314154935717" loading="lazy"></p>
<p>对 jdbc 源码分析的类图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172542.png" alt="image-20220314154956046" loading="lazy"></p>
<h2 id="桥接模式的注意事项和细节" tabindex="-1"><a class="header-anchor" href="#桥接模式的注意事项和细节" aria-hidden="true">#</a> 桥接模式的注意事项和细节</h2>
<ul>
...
<h2 id="桥接模式的应用场景" tabindex="-1"><a class="header-anchor" href="#桥接模式的应用场景" aria-hidden="true">#</a> 桥接模式的应用场景</h2>
...
<p>桥接模式的一个常见使用场景就是 <strong>替换掉继承</strong>。我们知道，继承拥有很多优点，比如，抽象、封装、多态等，父类封装共性，子类实现特性。继承可以很好的实现代码复用（封装）的功能，但这也是继承的一大缺点。</p>
<p>因为父类拥有的方法，子类也会继承得到，无论子类需不需要，这说明 <strong>继承具备强侵入性</strong>（父类代码侵入子类），同时会导致子类臃肿。因此，在设计模式中，<strong>有一个原则为优先使用组合/聚合，而不是继承</strong>。</p>
...
<h2 id="常见的应用场景" tabindex="-1"><a class="header-anchor" href="#常见的应用场景" aria-hidden="true">#</a> 常见的应用场景</h2>
<ul>
<li>JDBC 驱动程序</li>
<li>银行转账系统
<ul>
...
<h2 id="桥接模式模式的扩展" tabindex="-1"><a class="header-anchor" href="#桥接模式模式的扩展" aria-hidden="true">#</a> 桥接模式模式的扩展</h2>
<p>在软件开发中，有时桥接（Bridge）模式可与 <a href="https://notes.gavin.cn/design-pattern/adapter/" target="_blank" rel="noopener noreferrer">适配器模式<ExternalLinkIcon/></a> 联合使用。当桥接（Bridge）模式的实现化角色的接口与现有类的接口不一致时，可以在二者中间定义一个适配器将二者连接起来，其具体结构图如下图所示</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172545.png" alt="image-20220314155454968" loading="lazy"></p>
</div></template>
