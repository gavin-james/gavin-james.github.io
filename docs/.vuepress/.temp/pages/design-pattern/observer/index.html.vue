<template><div><nav class="table-of-contents"><ul><li><router-link to="#观察者模式基本介绍">观察者模式基本介绍</router-link></li><li><router-link to="#观察者模式的结构与实现">观察者模式的结构与实现</router-link></li><li><router-link to="#天气预报项目需求">天气预报项目需求</router-link></li><li><router-link to="#普通方案解决天气预报需求">普通方案解决天气预报需求</router-link><ul><li><router-link to="#逻辑分析">逻辑分析</router-link></li><li><router-link to="#代码实现">代码实现</router-link></li><li><router-link to="#问题分析">问题分析</router-link></li></ul></li><li><router-link to="#观察者模式解决天气预报需求">观察者模式解决天气预报需求</router-link></li><li><router-link to="#jdk-的观察者模式剖析">JDK 的观察者模式剖析</router-link></li><li><router-link to="#观察者模式的应用场景">观察者模式的应用场景</router-link></li></ul></nav>
<h2 id="观察者模式基本介绍" tabindex="-1"><a class="header-anchor" href="#观察者模式基本介绍" aria-hidden="true">#</a> 观察者模式基本介绍</h2>
...
<p>观察者模式的结构图如下所示：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326161322.png" alt="image-20220326161321893" loading="lazy"></p>
<p>代码实现：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 抽象目标</span>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326160527.png" alt="image-20220326160526405" loading="lazy"></p>
<p>说明：</p>
<ul>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326160614.png" alt="image-20220326160613310" loading="lazy"></p>
<p>CurrentConditions 可以理解成是我们气象局的网站。</p>
<h3 id="代码实现" tabindex="-1"><a class="header-anchor" href="#代码实现" aria-hidden="true">#</a> 代码实现</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CurrentConditions</span> <span class="token punctuation">{</span>
...
<p>类图：</p>
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326162334.png" alt="image-20220326162333026" loading="lazy"></p>
<p>代码实现：</p>
<p>观察者类</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 观察者接口，有观察者来实现</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 接口, 让 WeatherData 来实现 </span>
...
<p><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326162754.png" alt="image-20220326162754094" loading="lazy"></p>
<ul>
