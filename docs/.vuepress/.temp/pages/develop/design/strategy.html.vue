<template><div><h2 id="策略模式基本介绍" tabindex="-1"><a class="header-anchor" href="#策略模式基本介绍" aria-hidden="true">#</a> 策略模式基本介绍</h2>
...
<p>其结构图如图下所示：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326181158.png" alt="image-20220326181157415" tabindex="0" loading="lazy"><figcaption>image-20220326181157415</figcaption></figure>
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 抽象策略类</span>
...
<p>传统的设计方案（类图）</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326180057.png" alt="image-20220326180057205" tabindex="0" loading="lazy"><figcaption>image-20220326180057205</figcaption></figure>
...
<p>类图分析：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326181410.png" alt="image-20220326181409122" tabindex="0" loading="lazy"><figcaption>image-20220326181409122</figcaption></figure>
<p>代码实现：</p>
<p>飞行策略模式类</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">QuackBehavior</span> <span class="token punctuation">{</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326182516.png" alt="image-20220326182515064" tabindex="0" loading="lazy"><figcaption>image-20220326182515064</figcaption></figure>
<p>代码解释：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Strategy</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
