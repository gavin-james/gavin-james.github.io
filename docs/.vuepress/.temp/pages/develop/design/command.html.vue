<template><div><h2 id="命令模式基本介绍" tabindex="-1"><a class="header-anchor" href="#命令模式基本介绍" aria-hidden="true">#</a> 命令模式基本介绍</h2>
...
<p>结构图如下：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326121009.png" alt="image-20220326120837468" tabindex="0" loading="lazy"><figcaption>image-20220326120837468</figcaption></figure>
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 抽象命令</span>
...
<p>思路分析和类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326121346.png" alt="image-20220326121345564" tabindex="0" loading="lazy"><figcaption>image-20220326121345564</figcaption></figure>
<p>代码实现：</p>
<p>命令类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 创建命令接口</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 灯的遥控器</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">RemoteController</span> <span class="token punctuation">{</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326122116.png" alt="image-20220326122114890" tabindex="0" loading="lazy"><figcaption>image-20220326122114890</figcaption></figure>
<ul>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326122133.png" alt="image-20220326122132691" tabindex="0" loading="lazy"><figcaption>image-20220326122132691</figcaption></figure>
