<template><div><h2 id="模板方法模式基本介绍" tabindex="-1"><a class="header-anchor" href="#模板方法模式基本介绍" aria-hidden="true">#</a> 模板方法模式基本介绍</h2>
...
<p>模板方法模式的结构图如下：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326113625.png" alt="image-20220326113623976" tabindex="0" loading="lazy"><figcaption>image-20220326113623976</figcaption></figure>
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 抽象类</span>
...
<p>思路分析和类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326114123.png" alt="image-20220326114122266" tabindex="0" loading="lazy"><figcaption>image-20220326114122266</figcaption></figure>
...
<p>代码实现：</p>
<p>抽象类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 抽象类，表示豆浆</span>
