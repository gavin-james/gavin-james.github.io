<template><div><h2 id="原型模式基本介绍" tabindex="-1"><a class="header-anchor" href="#原型模式基本介绍" aria-hidden="true">#</a> 原型模式基本介绍</h2>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220302213646.png" alt="image-20220301174940372" tabindex="0" loading="lazy"><figcaption>image-20220301174940372</figcaption></figure>
...
<p>思路分析（图解）</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220302213643.png" alt="image-20220301174437773" tabindex="0" loading="lazy"><figcaption>image-20220301174437773</figcaption></figure>
<p>Sheep 类代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Sheep</span> <span class="token punctuation">{</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220302213648.png" alt="image-20220301175359902" tabindex="0" loading="lazy"><figcaption>image-20220301175359902</figcaption></figure>
