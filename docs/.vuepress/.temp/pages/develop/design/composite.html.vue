<template><div><h2 id="组合模式基本介绍" tabindex="-1"><a class="header-anchor" href="#组合模式基本介绍" aria-hidden="true">#</a> 组合模式基本介绍</h2>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172858.png" alt="image-20220314164535175" tabindex="0" loading="lazy"><figcaption>image-20220314164535175</figcaption></figure>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172855.png" alt="image-20220314170025485" tabindex="0" loading="lazy"><figcaption>image-20220314170025485</figcaption></figure>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172635.png" alt="image-20220314170106903" tabindex="0" loading="lazy"><figcaption>image-20220314170106903</figcaption></figure>
<p>下面为透明式的组合模式的实现代码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 抽象构件</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre java="" class="language-java"><code><span class="token comment">// 抽象构件</span>
<span class="token keyword">interface</span> <span class="token class-name">Component</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">operation</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
<span class="token comment">// 树叶构件</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172629.png" alt="image-20220314163409100" tabindex="0" loading="lazy"><figcaption>image-20220314163409100</figcaption></figure>
<h2 id="传统方案解决学校院系展示" tabindex="-1"><a class="header-anchor" href="#传统方案解决学校院系展示" aria-hidden="true">#</a> 传统方案解决学校院系展示</h2>
<p>类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172630.png" alt="image-20220314163646797" tabindex="0" loading="lazy"><figcaption>image-20220314163646797</figcaption></figure>
<p>分析：</p>
<ul>
...
<p>思路分析和图解（类图）</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172638.png" alt="image-20220314164610345" tabindex="0" loading="lazy"><figcaption>image-20220314164610345</figcaption></figure>
<blockquote>
<p>代码示例</p>
</blockquote>
<p>公共抽象组件</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">OrganizationComponent</span> <span class="token punctuation">{</span>
...
<p>类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172642.png" alt="image-20220314165737331" tabindex="0" loading="lazy"><figcaption>image-20220314165737331</figcaption></figure>
