<template><div><h2 id="桥接模式基本介绍" tabindex="-1"><a class="header-anchor" href="#桥接模式基本介绍" aria-hidden="true">#</a> 桥接模式基本介绍</h2>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172534.png" alt="image-20220314154132216" tabindex="0" loading="lazy"><figcaption>image-20220314154132216</figcaption></figure>
<p>上面图片桥接模式的代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 实现化角色</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172530.png" alt="image-20220314153744545" tabindex="0" loading="lazy"><figcaption>image-20220314153744545</figcaption></figure>
<h2 id="传统方案解决手机操作问题" tabindex="-1"><a class="header-anchor" href="#传统方案解决手机操作问题" aria-hidden="true">#</a> 传统方案解决手机操作问题</h2>
<p>传统方法对应的类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172532.png" alt="image-20220314153823688" tabindex="0" loading="lazy"><figcaption>image-20220314153823688</figcaption></figure>
...
<p>使用桥接模式对应的类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172536.png" alt="image-20220314154311971" tabindex="0" loading="lazy"><figcaption>image-20220314154311971</figcaption></figure>
<p>代码示例：</p>
<p>手机品牌代码</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Phone</span> <span class="token punctuation">{</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172540.png" alt="image-20220314154935717" tabindex="0" loading="lazy"><figcaption>image-20220314154935717</figcaption></figure>
<p>对 jdbc 源码分析的类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172542.png" alt="image-20220314154956046" tabindex="0" loading="lazy"><figcaption>image-20220314154956046</figcaption></figure>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172545.png" alt="image-20220314155454968" tabindex="0" loading="lazy"><figcaption>image-20220314155454968</figcaption></figure>
</div></template>
