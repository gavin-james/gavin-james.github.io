<template><div><h2 id="建造者模式基本介绍" tabindex="-1"><a class="header-anchor" href="#建造者模式基本介绍" aria-hidden="true">#</a> 建造者模式基本介绍</h2>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316221947.png" alt="image-20220316221946018" tabindex="0" loading="lazy"><figcaption>image-20220316221946018</figcaption></figure>
...
<p>思路分析（图解）</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220302213652.png" alt="image-20220301194218699" tabindex="0" loading="lazy"><figcaption>image-20220301194218699</figcaption></figure>
<p>AbstractHouse 类：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">AbstractHouse</span> <span class="token punctuation">{</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220302213657.png" alt="image-20220301195650273" tabindex="0" loading="lazy"><figcaption>image-20220301195650273</figcaption></figure>
<p>房子 House 类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">House</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">HouseBuilder</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HouseDirector</span> <span class="token punctuation">{</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220302213700.png" alt="image-20220301201855363" tabindex="0" loading="lazy"><figcaption>image-20220301201855363</figcaption></figure>
<p>源码中建造者模式角色分析：</p>
<ul>
