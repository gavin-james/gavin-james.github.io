<template><div><h2 id="中介者模式基本介绍" tabindex="-1"><a class="header-anchor" href="#中介者模式基本介绍" aria-hidden="true">#</a> 中介者模式基本介绍</h2>
...
<p>中介者模式的结构图如下所示：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326163810.png" alt="image-20220326163809453" tabindex="0" loading="lazy"><figcaption>image-20220326163809453</figcaption></figure>
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 抽象中介者</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326163155.png" alt="image-20220326163154437" tabindex="0" loading="lazy"><figcaption>image-20220326163154437</figcaption></figure>
...
<p>思路分析和类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326163932.png" alt="image-20220326163930542" tabindex="0" loading="lazy"><figcaption>image-20220326163930542</figcaption></figure>
<p>代码实现：</p>
<p>中介者类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 中介者抽象类</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 智能家具抽象类</span>
