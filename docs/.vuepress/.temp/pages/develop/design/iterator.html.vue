<template><div><h2 id="迭代器模式基本介绍" tabindex="-1"><a class="header-anchor" href="#迭代器模式基本介绍" aria-hidden="true">#</a> 迭代器模式基本介绍</h2>
...
<p>结构图如下所示：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326154815.png" alt="image-20220326154814205" tabindex="0" loading="lazy"><figcaption>image-20220326154814205</figcaption></figure>
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 抽象迭代器</span>
...
<p>设计思路分析：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326155108.png" alt="image-20220326155107325" tabindex="0" loading="lazy"><figcaption>image-20220326155107325</figcaption></figure>
<p>代码实现：</p>
<p>专业系类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Department</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">College</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">OutPutImpl</span> <span class="token punctuation">{</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326155826.png" alt="image-20220326155825142" tabindex="0" loading="lazy"><figcaption>image-20220326155825142</figcaption></figure>
<p>类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326155841.png" alt="image-20220326155841174" tabindex="0" loading="lazy"><figcaption>image-20220326155841174</figcaption></figure>
<p>对类图的角色分析和说明</p>
<ul>
