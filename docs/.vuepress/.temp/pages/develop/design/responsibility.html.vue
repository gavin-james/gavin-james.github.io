<template><div><h2 id="职责链模式基本介绍" tabindex="-1"><a class="header-anchor" href="#职责链模式基本介绍" aria-hidden="true">#</a> 职责链模式基本介绍</h2>
...
<p>其结构图如下图所示：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326184617.png" alt="image-20220326184616770" tabindex="0" loading="lazy"><figcaption>image-20220326184616770</figcaption></figure>
<p>客户端可按下图所示设置职责链：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326184655.png" alt="image-20220326184654465" tabindex="0" loading="lazy"><figcaption>image-20220326184654465</figcaption></figure>
<blockquote>
<p>代码实现</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 抽象处理者角色</span>
...
<p>思路分析和类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326183930.png" alt="image-20220326183929550" tabindex="0" loading="lazy"><figcaption>image-20220326183929550</figcaption></figure>
<p>代码实现：</p>
<p>职责链类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Approver</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 请求类</span>
