<template><div><h2 id="装饰器模式的定义与特点" tabindex="-1"><a class="header-anchor" href="#装饰器模式的定义与特点" aria-hidden="true">#</a> 装饰器模式的定义与特点</h2>
...
<p>装饰器模式的结构图如图所示：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172608.png" alt="image-20220314162328427" tabindex="0" loading="lazy"><figcaption>image-20220314162328427</figcaption></figure>
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 抽象构件角色</span>
...
<p>类图</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172604.png" alt="image-20220314160422590" tabindex="0" loading="lazy"><figcaption>image-20220314160422590</figcaption></figure>
<ul>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172606.png" alt="image-20220314160744377" tabindex="0" loading="lazy"><figcaption>image-20220314160744377</figcaption></figure>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172612.png" alt="image-20220314161222580" tabindex="0" loading="lazy"><figcaption>image-20220314161222580</figcaption></figure>
<p>订单分析图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172614.png" alt="image-20220314161323609" tabindex="0" loading="lazy"><figcaption>image-20220314161323609</figcaption></figure>
<p>代码示例</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Drink</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CoffeeBar</span> <span class="token punctuation">{</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314172618.png" alt="image-20220314162102077" tabindex="0" loading="lazy"><figcaption>image-20220314162102077</figcaption></figure>
<ul>
