<template><div><h2 id="代理模式的基本介绍" tabindex="-1"><a class="header-anchor" href="#代理模式的基本介绍" aria-hidden="true">#</a> 代理模式的基本介绍</h2>
...
<p>代理模式示意图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213434.png" alt="image-20220314192143394" tabindex="0" loading="lazy"><figcaption>image-20220314192143394</figcaption></figure>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316221212.png" alt="image-20220316221211102" tabindex="0" loading="lazy"><figcaption>image-20220316221211102</figcaption></figure>
...
<p>思路分析图解（类图）</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213702.png" alt="image-20220316213701600" tabindex="0" loading="lazy"><figcaption>image-20220316213701600</figcaption></figure>
<p>代码实现</p>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220325225315.png" alt="image-20220325225306403" tabindex="0" loading="lazy"><figcaption>image-20220325225306403</figcaption></figure>
...
<p>类图</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316215717.png" alt="image-20220316215716168" tabindex="0" loading="lazy"><figcaption>image-20220316215716168</figcaption></figure>
<p>代码实现</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 接口</span>
<span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">ITeacherDao</span> <span class="token punctuation">{</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220325225355.png" alt="image-20220325225354561" tabindex="0" loading="lazy"><figcaption>image-20220325225354561</figcaption></figure>
<blockquote>
<p>思路</p>
</blockquote>
<ol>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316220551.png" alt="image-20220316220549595" tabindex="0" loading="lazy"><figcaption>image-20220316220549595</figcaption></figure>
<p>代码实现</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// Cglib 代理不需要接口</span>
