<template><div><h2 id="享元模式基本介绍" tabindex="-1"><a class="header-anchor" href="#享元模式基本介绍" aria-hidden="true">#</a> 享元模式基本介绍</h2>
...
<li>
<p>外部状态指对象得以依赖的一个标记，随环境的改变而改变，不可共享<br>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213417.png" alt="image-20220314190648003" tabindex="0" loading="lazy"><figcaption>image-20220314190648003</figcaption></figure>
<p>下面享元模式的结构图，其中：</p>
<ul>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213419.png" alt="image-20220314190636066" tabindex="0" loading="lazy"><figcaption>image-20220314190636066</figcaption></figure>
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 抽象享元角色</span>
...
<p>给每个网站租用一个空间。</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213422.png" alt="image-20220314190248901" tabindex="0" loading="lazy"><figcaption>image-20220314190248901</figcaption></figure>
...
<p>类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213425.png" alt="image-20220314190856461" tabindex="0" loading="lazy"><figcaption>image-20220314190856461</figcaption></figure>
<p>代码实现：</p>
<p>User 类：</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">WebSite</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 网站工厂类，根据需要返回压一个网站</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213452.png" alt="image-20220314191251956" tabindex="0" loading="lazy"><figcaption>image-20220314191251956</figcaption></figure>
<p>代码说明：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FlyWeight</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
