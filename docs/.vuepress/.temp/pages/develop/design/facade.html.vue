<template><div><h2 id="外观模式基本介绍" tabindex="-1"><a class="header-anchor" href="#外观模式基本介绍" aria-hidden="true">#</a> 外观模式基本介绍</h2>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314175540.png" alt="image-20220314175538719" tabindex="0" loading="lazy"><figcaption>image-20220314175538719</figcaption></figure>
<h3 id="模式的实现" tabindex="-1"><a class="header-anchor" href="#模式的实现" aria-hidden="true">#</a> 模式的实现</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 子系统角色</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314175113.png" alt="image-20220314175108493" tabindex="0" loading="lazy"><figcaption>image-20220314175108493</figcaption></figure>
...
<p>示意图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314175731.png" alt="image-20220314175728964" tabindex="0" loading="lazy"><figcaption>image-20220314175728964</figcaption></figure>
<p>影院管理项目类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314175755.png" alt="image-20220314175754422" tabindex="0" loading="lazy"><figcaption>image-20220314175754422</figcaption></figure>
<p>代码示例：</p>
<p>影院的 DVD 播放器、投影仪、自动屏幕、环绕立体声、爆米花机、灯光类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// DVD 播放器</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HomeTheaterFacade</span> <span class="token punctuation">{</span>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314180359.png" alt="image-20220314180358602" tabindex="0" loading="lazy"><figcaption>image-20220314180358602</figcaption></figure>
<p>对源码中使用到的外观模式的角色类图</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220314180444.png" alt="image-20220314180442486" tabindex="0" loading="lazy"><figcaption>image-20220314180442486</figcaption></figure>
