<template><div><h2 id="访问者模式基本介绍" tabindex="-1"><a class="header-anchor" href="#访问者模式基本介绍" aria-hidden="true">#</a> 访问者模式基本介绍</h2>
...
<p>结构图如下：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326123352.png" alt="image-20220326123351242" tabindex="0" loading="lazy"><figcaption>image-20220326123351242</figcaption></figure>
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 抽象访问者</span>
...
<p>思路分析和类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326123659.png" alt="image-20220326123658042" tabindex="0" loading="lazy"><figcaption>image-20220326123658042</figcaption></figure>
<p>代码实现：</p>
<p>行为类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Action</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 数据结构，管理很多人（Man , Woman）</span>
