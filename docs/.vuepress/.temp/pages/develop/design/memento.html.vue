<template><div><h2 id="备忘录模式基本介绍" tabindex="-1"><a class="header-anchor" href="#备忘录模式基本介绍" aria-hidden="true">#</a> 备忘录模式基本介绍</h2>
...
<p>备忘录模式的结构图如下图所示：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326165254.png" alt="image-20220326165253607" tabindex="0" loading="lazy"><figcaption>image-20220326165253607</figcaption></figure>
<p>代码实现：</p>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326164848.png" alt="image-20220326164847860" tabindex="0" loading="lazy"><figcaption>image-20220326164847860</figcaption></figure>
...
<p>思路分析和类图：</p>
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326165602.png" alt="image-20220326165601510" tabindex="0" loading="lazy"><figcaption>image-20220326165601510</figcaption></figure>
<p>代码实现：</p>
<p>备忘录类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Memento</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 守护者对象, 保存游戏角色的状态</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">GameRole</span> <span class="token punctuation">{</span>
