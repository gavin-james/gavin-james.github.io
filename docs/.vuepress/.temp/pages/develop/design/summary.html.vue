<template><div><h2 id="掌握设计模式的层次" tabindex="-1"><a class="header-anchor" href="#掌握设计模式的层次" aria-hidden="true">#</a> 掌握设计模式的层次</h2>
<ul>
...
<figure><img src="https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220326231408.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>分享金句：</p>
<ul>
