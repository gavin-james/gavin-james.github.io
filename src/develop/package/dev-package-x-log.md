...
![img](https://www.pdai.tech/images/develop/package/dev-package-log-1.png)

异步写日志的benchmark：

![img](https://www.pdai.tech/images/develop/package/dev-package-log-2.png)

当然，这些benchmark都是在日志Pattern中不包含Location信息（如日志代码行号 ，调用者信息，Class名/源码文件名等）时测定的，如果输出Location信息的话，性能谁也拯救不了：

![img](https://www.pdai.tech/images/develop/package/dev-package-log-3.png)
...
官网地址: [http://commons.apache.org/proper/commons-logging/在新窗口打开](http://commons.apache.org/proper/commons-logging/)
...
![img](https://www.pdai.tech/images/develop/package/dev-package-log-6.png)
...
![img](https://www.pdai.tech/images/develop/package/dev-package-log-5.png)
...
![img](https://www.pdai.tech/images/develop/package/dev-package-log-4.png)
