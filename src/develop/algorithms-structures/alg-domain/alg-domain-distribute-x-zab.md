...
[什么是 ZAB 协议？ ZAB 协议介绍]()[消息广播]()[崩溃恢复]()[数据同步]()[总结]()[参考文章]()
...
![img](https://www.pdai.tech/images/alg/alg-zab-1.png)
...
![img](https://www.pdai.tech/images/alg/alg-zab-2.png)

等待 Follwer 回应 Ack，最低超过半数即成功

![img](https://www.pdai.tech/images/alg/alg-zab-3.png)

当超过半数成功回应，则执行 commit ，同时提交自己

![img](https://www.pdai.tech/images/alg/alg-zab-4.png)
...
![img](https://www.pdai.tech/images/alg/alg-zab-5.png)
...
![img](https://www.pdai.tech/images/alg/alg-zab-6.png)
