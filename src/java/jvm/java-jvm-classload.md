...
- 调用类的静态方法
- 反射(如Class.forName("com.gavin.james.jvm.Test"))
...
```java
package com.gavin.james.jvm.classloader;
...
public class MyClassLoader extends ClassLoader {
    ...
    public static void main(String[] args)  {
        ...
        try {
            testClass = classLoader.loadClass("com.gavin.james.jvm.classloader.Test2");
...
1、这里传递的文件名需要是类的全限定性名称，即`com.gavin.james.jvm.classloader.Test2`格式的，因为 defineClass 方法是按这种格式进行处理的。
