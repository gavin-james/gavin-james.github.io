...
# 查看这个某个类所有的方法
sm com.gavin.james.servlet.TestMyServlet *

# 查看某个方法的信息，如果存在的话
sm com.gavin.james.servlet.TestMyServlet testMethod  
```
...
jad com.gavin.james.servlet.TestMyServlet
```
...
```bash
# 同时监控入参，返回值，及异常
watch com.gavin.james.servlet.TestMyServlet testMethod "{params, returnObj, throwExp}" -e -x 2 
```
...
```bash
stack com.gavin.james.servlet.TestMyServlet testMethod
```
...
trace com.gavin.james.servlet.TestMyServlet testMethod
```
