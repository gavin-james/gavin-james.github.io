...
![img](https://www.pdai.tech/images/java/java-basic-generic-5.png)
...
![img](https://www.pdai.tech/images/java/java-basic-generic-1.png)
...
![img](https://www.pdai.tech/images/java/java-basic-generic-2.png)

- 擦除方法定义中的类型参数

擦除方法定义中的类型参数原则和擦除类定义中的类型参数是一样的，这里仅以擦除方法定义中的有限制类型参数为例。

![img](https://www.pdai.tech/images/java/java-basic-generic-3.png)
...
著作权归所有 原文链接：https://pdai.tech/md/java/basic/java-basic-x-generic.html