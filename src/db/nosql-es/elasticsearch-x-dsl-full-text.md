...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-1.png)

- 第三点： **知识点还是API**？ API类型的是可以查询的，只需要知道大致有哪些功能就可以了。

![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-2.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-4.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-5.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-6.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-7.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-8.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-9.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-11.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-12.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-13.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-14.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-15.png)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-16.png)

更多请参考[官网在新窗口打开](https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-simple-query-string-query.html)
...
![img](https://www.pdai.tech/images/db/es/es-dsl-full-text-17.png)
