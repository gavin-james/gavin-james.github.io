...
> 更新缓存的的Design Pattern有四种：Cache aside, Read through, Write through, Write behind caching; 我强烈建议你看看这篇，左耳朵耗子的文章：[缓存更新的套路在新窗口打开](https://coolshell.cn/articles/17416.html)
...
![img](https://www.pdai.tech/images/db/redis/db-redis-cache-2.png)

![img](https://www.pdai.tech/images/db/redis/db-redis-cache-3.png)
