...
![img](https://www.pdai.tech/images/db/redis/redis-cluster-3.png)
...
![img](https://www.pdai.tech/images/db/redis/redis-cluster-4.png)

### ASK 重定向

Ask重定向发生于集群伸缩时，集群伸缩会导致槽迁移，当我们去源节点访问时，此时数据已经可能已经迁移到了目标节点，使用Ask重定向来解决此种情况。

![img](https://www.pdai.tech/images/db/redis/redis-cluster-5.png)
...
![img](https://www.pdai.tech/images/db/redis/redis-cluster-6.png)

- 将上述映射关系存到本地，通过映射关系就可以直接对目标节点进行操作（CRC16(key) -> slot -> node），很好地避免了Moved重定向，并为每个节点创建JedisPool
- 至此就可以用来进行命令操作

![img](https://www.pdai.tech/images/db/redis/redis-cluster-7.png)
...
![img](https://www.pdai.tech/images/db/redis/redis-cluster-1.png)
...
![img](https://www.pdai.tech/images/db/redis/redis-cluster-2.png)
...
![img](https://www.pdai.tech/images/db/redis/db-redis-cluster-1.png)
...
![img](https://www.pdai.tech/images/db/redis/db-redis-cluster-2.png)
...
![img](https://www.pdai.tech/images/db/redis/db-redis-cluster-3.png)
