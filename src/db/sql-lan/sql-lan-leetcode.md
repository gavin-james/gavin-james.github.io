...
参考: [pMySQL Error 1093 - Can't specify target table for update in FROM clause在新窗口打开](https://stackoverflow.com/questions/45494/mysql-error-1093-cant-specify-target-table-for-update-in-from-clause)
